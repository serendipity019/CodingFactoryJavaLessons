...
public class ExceptionTypes {
    ...
    public static char readOneChar() throws IOException {
        return (char) System.in.read(); // throws IO exception
    }

    /**
     * If we catch the exception, no need for 'throws' in method signature.
     * And the exception not propagates. Is it a good practice, not to propagate?
     * It depends. If there is caller, then we have to propagate.
     * If here is a client / user the we do not propagate the exception.
     * @return
     */
